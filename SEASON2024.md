...
Here is my walkthrough of using `player_stats_*_season_{2021 - 2023}.csv` to
rank the players in `roster_weekly_2024.csv` in terms of, "given what we know
...
training examples by label value, which a log transformation doesn't re-order).
